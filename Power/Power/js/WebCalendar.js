...
Calendar.prototype.draw = function() {
  ...
  mvAry[mvAry.length]  = '    <table id="calendarTable" width="100%" style="font-size: 12px;border:0px solid #CCCCCC;background-color:#FFFFFF" border="0" cellpadding="3" cellspacing="1">';
  mvAry[mvAry.length]  = '      <tr>';
  for(var i = 0; i < 7; i++) {
...
if(document.all)
{
document.write('<iframe src="../../blank.aspx" style="position:absolute;z-index:2000;width:expression(this.previousSibling.offsetWidth);');
