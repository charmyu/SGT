...
<script runat="server">
    ...
    void Page_Init(object sender, EventArgs e)
    {
         ...
         if (this.WordDictionary == null)
         {
             ...
             if (System.Web.Configuration.WebConfigurationManager.AppSettings["DictionaryFolder"] == null)
				folderName = this.MapPath("~/bin");
			 else
			 {
                 folderName = System.Web.Configuration.WebConfigurationManager.AppSettings["DictionaryFolder"];
