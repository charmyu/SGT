(function ($)
{
            ...
            errorPlacement: function (lable, element) {
                ...
                switch (msgType) {
                    case "msgtext":
                        ...
                        msgHtml = "<p id ='"+ element.attr("name") + "_msg_p'><span style='margin-top:17px;'><span class='validateimg'></span><span id='"
                                        + element.attr("name") + "_msg' style='line-height: 25px; color: red; float:left'>" + errMsg + "</span></p>";
    ...
    LV.closeTab = function (tabid)
    {
        ...
        if (tab)
        {
            ...
            tab.removeTabItem(str2asc(tabid));
        }
    };
