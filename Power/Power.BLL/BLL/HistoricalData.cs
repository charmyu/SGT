...
namespace Power.BLL
{
	...
	{
		private readonly Power.DAL.HistoricalData dal=new Power.DAL.HistoricalData();
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public Power.Model.HistoricalData GetModelByCache(string ID)
        //{
			
        //    string CacheKey = "HistoricalDataModel-" + ID;
        ...
        //        catch{}
        //    }
        //    return (Power.Model.HistoricalData)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.HistoricalData> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.HistoricalData> DataTableToList(DataTable dt)
		{
			List<Power.Model.HistoricalData> modelList = new List<Power.Model.HistoricalData>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Power.Model.HistoricalData model;
        ...
        {
            return dal.GetLineDataByDeviceID(strWhere, sdate, sfun);
        }
        ...
        {
            return dal.GetDataTableByDeviceID(strWhere, sdate, sfun);
        }
