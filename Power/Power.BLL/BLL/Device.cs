...
namespace Power.BLL
{
	...
	{
		private readonly Power.DAL.Device dal=new Power.DAL.Device();
		public Device()
		{}
		#region  BasicMethod
		/// <summary>
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public Power.Model.Device GetModelByCache(string ID)
        //{
        ...
        //        catch{}
        //    }
        //    return (Power.Model.Device)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.Device> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.Device> DataTableToList(DataTable dt)
		{
			List<Power.Model.Device> modelList = new List<Power.Model.Device>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Power.Model.Device model;
        ...
        {
            return dal.GetDevcieDataList(strWhere);
        }
        ...
        {
            return dal.GetDevcieHistoricalData(strWhere);
        }
        ...
        {
            return dal.GetDevcieMainData(strWhere);
        }
