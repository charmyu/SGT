...
namespace Power.BLL
{
	...
	{
		private readonly Power.DAL.MenuInfo dal=new Power.DAL.MenuInfo();
		public MenuInfo()
		{}
		#region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public Power.Model.MenuInfo GetModelByCache(int Menu_ID)
        //{
			
        //    string CacheKey = "MenuInfoModel-" + Menu_ID;
        ...
        //        catch{}
        //    }
        //    return (Power.Model.MenuInfo)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.MenuInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.MenuInfo> DataTableToList(DataTable dt)
		{
			List<Power.Model.MenuInfo> modelList = new List<Power.Model.MenuInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Power.Model.MenuInfo model;
