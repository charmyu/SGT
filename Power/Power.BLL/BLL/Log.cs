...
namespace Power.BLL
{
	...
	{
		private readonly Power.DAL.Log dal=new Power.DAL.Log();
		public Log()
		{}
		#region  BasicMethod
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public Power.Model.Log GetModelByCache(int Log_ID)
        //{
			
        //    string CacheKey = "LogModel-" + Log_ID;
        ...
        //        catch{}
        //    }
        //    return (Power.Model.Log)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.Log> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.Log> DataTableToList(DataTable dt)
		{
			List<Power.Model.Log> modelList = new List<Power.Model.Log>();
