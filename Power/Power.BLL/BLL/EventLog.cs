...
namespace Power.BLL
{
	...
	{
		private readonly Power.DAL.EventLog dal=new Power.DAL.EventLog();
		public EventLog()
		{}
		#region  BasicMethod
		/// <summary>
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public Power.Model.EventLog GetModelByCache(string ID)
        //{
			
        //    string CacheKey = "EventLogModel-" + ID;
        ...
        //        catch{}
        //    }
        //    return (Power.Model.EventLog)objModel;
        //}
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.EventLog> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Power.Model.EventLog> DataTableToList(DataTable dt)
		{
			List<Power.Model.EventLog> modelList = new List<Power.Model.EventLog>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Power.Model.EventLog model;
        ...
        {
           return dal.GetAllRelationTable(strWhere);
        }
